...
- Phase 7: all six first-party scenario packs have declarative reference solutions; the catalog includes additional virtual `date`, text-processing, file-management, identity, DNS, package, process, and storage inspection commands without host execution.
