...
- All six first-party package directories include alternate declarative solution paths, golden report structure fixtures, and automated initial/final score, reset, replay, and host-isolation gates. Scenario-specific mechanics remain intentionally small compared with a full RHEL installation.
